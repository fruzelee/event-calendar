...
import com.github.fruzelee.eventcalendar.extensions.addBitIf
...
data class Event(
    ...
    fun addIntervalTime(original: Event) {
        ...
        val newStart: DateTime = when (repeatInterval) {
    ...
    fun getEveCalCalendarId() = if (source.startsWith(CALDAV)) (source.split("-").lastOrNull() ?: "0").toString().toInt() else 0
