...
import com.github.fruzelee.eventcalendar.helpers.DAY_SECONDS
import com.github.fruzelee.eventcalendar.helpers.HOUR_SECONDS
...
class CustomIntervalPickerDialog(val activity: Activity, private val selectedSeconds: Int = 0, val showSeconds: Boolean = false, val callback: (minutes: Int) -> Unit) {
        ...
        dialog = AlertDialog.Builder(activity)
                ...
                .create().apply {
                    activity.setupDialogStuff(view, this) {
                        activity.showKeyboard(view.dialog_custom_interval_value)
                    }
                }
    }
