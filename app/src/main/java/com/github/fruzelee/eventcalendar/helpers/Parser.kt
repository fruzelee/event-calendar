...
import com.github.fruzelee.eventcalendar.models.EventRepetition
...
class Parser {
    ...
    private fun parseDateTimeValue(value: String): Long {
    ...
    private fun getByDay(event: Event) = when {
        ...
        event.repeatInterval.isXMonthlyRepetition() || event.repeatInterval.isXYearlyRepetition() -> when (event.repeatRule) {
            REPEAT_LAST_DAY -> ";$BY_MONTH_DAY=-1"
